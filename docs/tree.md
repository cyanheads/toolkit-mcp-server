...
Generated on: 2026-09-13 17:52:30
...
│   │   └── tools/
│   │       └── definitions/
│   │           ├── check-network.tool.ts
│   │           ├── check-system.tool.ts
│   │           ├── encode-value.tool.ts
│   │           ├── generate-id.tool.ts
│   │           ├── generate-qr.tool.ts
│   │           ├── geolocate-ip.tool.ts
│   │           └── hash-value.tool.ts
│   ├── services/
│   │   ├── geo/
│   │   │   ├── geo-service.ts
...
│       ├── check-system.tool.test.ts
│       ├── encode-value.tool.test.ts
